...
$PAGE->set_url('/mod/scorm/loadSCO.php', ['scoid' => $scoid, 'id' => $cm->id]);
...
$scolaunchurl = str_replace("/mod_scorm/", "/local_kopere_mobile/", $scolaunchurl);
// $scolaunchurl = str_replace("/pluginfile.php", "/local/kopere_mobile/pluginfile.php", $scolaunchurl);
...
echo html_writer::tag('body', html_writer::tag('p', get_string('activitypleasewait', 'scorm')), ['onload' => "doredirect();"]);
echo html_writer::end_tag('html');
