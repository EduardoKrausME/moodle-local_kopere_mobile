    ...
    Y.use('button', 'dd-plugin', 'panel', 'resize', 'gallery-sm-treeview', function(Y) {
        ...
        var scorm_activate_item = function(node) {
            ...
            if (old) {
                ...
                var node_full_url = M.cfg.wwwroot + '/local/kopere_mobile/scorm/loadSCO.php?' + node.title;
            ...
            var url_prefix = M.cfg.wwwroot + '/local/kopere_mobile/scorm/loadSCO.php?';
            ...
            if (old) {
                if (window_name) {
                    ...
                    scorm_openpopup(M.cfg.wwwroot + "/local/kopere_mobile/scorm/loadSCO.php?" + node.title, window_name, poptions, cwidth, cheight);
                }
            } else {
                content.prepend(obj);
            }
